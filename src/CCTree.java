    ...
    public void priTree(String letter, int i){
        if(tokens.get(i+2).getValueOfToken().equals(letter)){
            ...
            //System.out.print(i);
                    ...
                    tree.add(getTree(38, "[ " +tokens.get(i+2).getValueOfToken() + " ]", 37));// [ x ]
                    if(tokens.get(i+3).getTypeOfToken().equals("PLUS")){ //case for int expr within print statement
                        tree.add(getTree(39, "[ " +tokens.get(i+3).getValueOfToken() + " ]", 37));// [ + ]
                        tree.add(getTree(390, "[ " +tokens.get(i+4).getValueOfToken() + " ]", 37));// [ x ]
